...
export default function AdminQueuePage() {
  ...
  if (loadState === "error") {
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center gap-space-md bg-surface text-center">
  ...
  return (
    <div className="min-h-dvh bg-surface pb-space-xl">
      ...
      <div className="sticky top-[65px] z-10 mx-auto flex max-w-2xl gap-space-xs border-b border-surface-container-highest bg-surface px-margin py-space-sm">
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-12 flex-1 items-center justify-center gap-space-xs rounded-full px-space-sm font-headline-md text-headline-md uppercase tracking-wide transition-colors ${
                active
      ...
      <main className="mx-auto flex max-w-2xl flex-col gap-space-sm px-margin pt-space-md">
